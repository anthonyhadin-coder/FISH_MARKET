...
const DynamicFleetOverviewChart = dynamic(
    () => import('./FleetOverviewChart'),
    { 
        ssr: false, 
        loading: () => <div className="animate-pulse bg-slate-50 w-full h-full rounded-xl"></div> 
    }
);
                        ...
                        <>
                            ...
                            <Card className="p-8 rounded-[2rem] bg-white border-ocean-100 shadow-sm">
                                ...
                                <div className="h-[300px] w-full">
                                        <DynamicFleetOverviewChart fleetData={fleetData} />
                                </div>
                            </Card>
