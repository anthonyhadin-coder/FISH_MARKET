...
export const G = {
    ...
    accent: "#0EA5E9", text: "#082F49", muted: "#475569", subtle: "#94A3B8",
    green: "#10B981", red: "#F43F5E", amber: "#F59E0B", blue: "#3B82F6",
    inputBg: "#F8FAFC", inputBorder: "#BAE6FD",
};

/* ── UI Components ───────────────────────────────── */
export const Label = ({ c, style, ...props }: { c: string, style?: React.CSSProperties, [key: string]: any }) => (
...
export const Badge = ({ color = "#6366F1", children, style, ...props }: { color?: string, children: React.ReactNode, style?: React.CSSProperties, [key: string]: any }) => (
...
export const Divider = ({ style, ...props }: { style?: React.CSSProperties, [key: string]: any }) => (
