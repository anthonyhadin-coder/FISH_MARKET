...
import { Boat, Buyer, ApiError } from '@fishmarket/shared-types';
...
interface EntryTabProps {
    ...
    // Lifted props
    newRow: { fish: string; weight: string; rate: string; buyer: string; paid: string; total: string; balance: string };
    setNR: React.Dispatch<React.SetStateAction<{ fish: string; weight: string; rate: string; buyer: string; paid: string; total: string; balance: string }>>;
    addRow: () => Promise<void>;
